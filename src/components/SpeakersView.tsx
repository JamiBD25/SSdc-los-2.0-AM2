    ...
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 space-y-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="los-glass-card p-3.5 text-center">
          ...
          <span className="block font-['Orbitron'] font-black text-xl text-amber-300">{speakers.length}</span>
        </div>
        <div className="los-glass-card p-3.5 text-center">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-[#1F1A17] text-[#c9b8a7] text-xs font-bold uppercase tracking-wider border-b border-[#684B35]">
                ...
                <th className="py-4 px-4">Debater Name</th>
                ...
                <th className="py-4 px-4 text-right">Best Score</th>
                  ...
                  >
                    ...
                    <td className="py-3.5 px-4 text-center">
                      {hasSpoken ? (
                        ...
                        <span className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-[11px] font-bold bg-stone-900 text-stone-400 border border-stone-700">
                          N/A (Pending)
                        </span>
                      )}
                    </td>
